...
(function( $, undefined ) {
	...
	$.widget( "mobile.pagecontainer", {
		...
		load: function( url, options ) {
		    ...
		    //BL2014-05-30 fix the mobile.changepage bug (removing x-wmapp0: ) taken from 
		    //http://stackoverflow.com/questions/15248911/jquery-mobile-changepage-not-working-in-windows-phone/19984289#comment30232740_19984289
                    if(jquery_is_windows)
                        {
	...
	_createModal: function() {
		...
		self._modal = $( "<div class='" + self.options.classes.modal + "'></div>" )
			.on( "mousedown", function() {
                                                                displaySide('none');
                                                                $.mobile.silentScroll(_scrollTop);
				self.close();
			})
			.appendTo( target );
	},
