    ...
    Plugin.prototype = {
        init: function() {
            ...
            this.telInput.keyup(function() {
                ...
                var dialCode = that._getDialCode(that.telInput.val()) || "65";
        ...
        _selectListItem: function(listItem) {
            ...
            var checkPage = $("#lblCountSec").length;
            if (checkPage > 0) {
                checkPreMobile(newNumber.replace(" ", "")+ $("#txtMobile").val());
            }

            this.telInput.val(newNumber.replace(" ", ""));
            // hide dropdown again
            this._closeDropdown();
            // focus the input
            this.telInput.focus();
        ...
        _getDialCode: function(inputVal) {
            return getCountryCode(inputVal);
        },
...
function getCountryCode(inputVal) {
