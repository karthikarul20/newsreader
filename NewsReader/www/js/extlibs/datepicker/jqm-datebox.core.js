		...
		open: function () {
			...
			if ( o.enablePopup === true ) {
				...
				if ( o.useHeader === true ) {
					...
					$("<a class='ui-btn-left' href='#' style='border-style:none;margin-left:5px;margin-top:5px'>Close</a>").appendTo(w.d.headHTML)
				...
				if ( o.dialogForce || ( o.dialogEnable && window.width() < 400 ) ) {
					...
					w.d.mainWrap.append(w.d.intHTML).css('zIndex', 99999);
